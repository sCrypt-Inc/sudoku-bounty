...
export function parseProofFile(path: PathLike): Proof {
    ...
    const proof: Proof = {
        a: {
            x: BigInt(parsedJSON['pi_a'][0]),
            y: BigInt(parsedJSON['pi_a'][1]),
        },
        b: {
            x: {
                x: BigInt(parsedJSON['pi_b'][0][0]),
                y: BigInt(parsedJSON['pi_b'][0][1]),
            },
            y: {
                x: BigInt(parsedJSON['pi_b'][1][0]),
                y: BigInt(parsedJSON['pi_b'][1][1]),
            },
        },
        c: {
            x: BigInt(parsedJSON['pi_c'][0]),
            y: BigInt(parsedJSON['pi_c'][1]),
        },
    }
